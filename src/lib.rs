...
#[derive(Debug)]
pub struct TestPackageProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TestPackageProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TestPackage processing");
    
    let mut processor = TestPackageProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TestPackageProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TestPackageProcessor::new(false);
